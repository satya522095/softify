...
const songs = [
    {
        id:1,
        songName:`Saj ke sawar ke jab Aawelu...<br>
        <div class="subtitle">Khesari Lal Yadav</div>`,
        poster:"/image/Kheshari/01.jpeg"
     
    },
    {
        id:2,
        songName:`Jan Mare Lahnga yee lakhnauwa.... <br>
        <div class="subtitle">Khesari Lal Yadav</div>`,
        poster:"/image/Kheshari/02.jpeg"
         
    },
    {
        id: 3,
        songName: `Pagal Banaibe Ka re Patarki..... <br>
                    <div class="subtitle">Khesari Lal Yadav</div>`,
        poster: "/image/Kheshari/03.jpeg"
    },
    {
        id: 4,
        songName: `Kawan Bhatarkatni Bhatar Ke fasaulas... <br>
                    <div class="subtitle">Khesari Lal Yadav</div>`,
        poster: "/image/Kheshari/04.jpeg"
    },
    {
        id: 5,
        songName: `Aaja Aaja Kareja me samaja ho aaja aaja.. <br>
                    <div class="subtitle">Khesari Lal Yadav</div>`,
        poster: "/image/Kheshari/05.jpeg"
    },
    {
        id: 6,
        songName: `Kular Kurti me lagala...<br>
                    <div class="subtitle">Khesari Lal Yadav</div>`,
        poster: "/image/Kheshari/06.jpeg"
    },
    {
        id: 7,
        songName: `Tabla Bhojpuri song.. <br>
                    <div class="subtitle">
                    Khesari Lal Yadav and Shilpi Raj
                    </div>`,
        poster: "/image/Kheshari/07.jpeg"
    },
    {
        id: 8,
        songName: `Nathuniya Bhojpuri song.. <br>
                    <div class="subtitle">Khesari Lal Yadav</div>`,
        poster: "/image/Kheshari/08.jpeg"
    },
    {
        id: 9,
        songName: `Marad Abhi Baccha Ba...<br>
                    <div class="subtitle">Khesari Lal Yadav and Priyanka Singh</div>`,
        poster: "/image/Kheshari/09.jpeg"
    },
    {
        id: 10,
        songName: `Naach Re Patarki... <br>
                    <div class="subtitle">Khesari Lal Yadav</div>`,
        poster: "/image/Kheshari/10.jpeg"
    },
];
/*// By default play this song */

music.src = `music/Khesari/01.mp3`;
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index=el.target.id;
        // music.play();
        // /music/Khesari/${index}.mp3
        music.src=`/music/Khesari/${index}.mp3`;
        poster_play.src=`/image/Kheshari/${index}.jpeg`;
        music.play();
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href = `/music/Khesari/${index}.mp3`;
